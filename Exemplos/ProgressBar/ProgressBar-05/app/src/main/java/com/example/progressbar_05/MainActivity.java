package com.example.progressbar_05;
...
{      
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        btnBotao01 = (Button) findViewById(R.id.idBotao01);
        btnBotao01.setOnClickListener(new OnClickListener()
        {
    ...
    protected Dialog onCreateDialog(int id) 
    {
        ...
        case 0:                      
	            ...
	            progDialog.setMessage("Carregando ...");
        ...
        case 1:                      
	            ...
	            progDialog.setMessage("Perda de Pressão");
	            progThread = new ProgressThread(handler);
	            progThread.start();
	            return progDialog;
