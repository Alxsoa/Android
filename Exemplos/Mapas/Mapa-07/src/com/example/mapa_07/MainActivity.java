		...
		// PARSER JSON
			public List<LatLng> buildJSONRoute(String json) throws JSONException{
				...
				for(int i=0; i < steps.length(); i++) {
					Log.i("MeuLog", "STEP: LAT: "+steps.getJSONObject(i).getJSONObject("start_location").getDouble("lat")+" | LNG: "+steps.getJSONObject(i).getJSONObject("start_location").getDouble("lng"));
					...
					Log.i("MeuLog", "STEP: LAT: "+steps.getJSONObject(i).getJSONObject("end_location").getDouble("lat")+" | LNG: "+steps.getJSONObject(i).getJSONObject("end_location").getDouble("lng"));
				}
		...
		// DECODE POLYLINE
			private List<LatLng> decodePolyline(String encoded) {
				...
				while (index < len) {
					...
					Log.i("MeuLog", "POL: LAT: "+p.latitude+" | LNG: "+p.longitude);
					listPoints.add(p);
				}
				return listPoints;
			}
